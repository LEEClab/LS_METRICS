...
class LSMetrics(wx.Panel):
    def __init__(self, parent, id):
        ...
        self.editspeciesList=wx.ComboBox(self, 93, self.species_profile, wx.Point(80, 115), wx.Size(280, -1),
        ...
        #caixa de mensagem
        self.logger = wx.TextCtrl(self,5, '',wx.Point(200,370), wx.Size(160,150),wx.TE_MULTILINE | wx.TE_READONLY)
        
        self.editname = wx.TextCtrl(self, 190, '', wx.Point(160, 82),
                                    wx.Size(100,-1)) #Regular expression
        self.editname = wx.TextCtrl(self, 191, '', wx.Point(250,173), wx.Size(80,-1)) #gap crossing
        self.editname = wx.TextCtrl(self, 192, '', wx.Point(250,205), wx.Size(80,-1)) #list deph edge
        self.editname = wx.TextCtrl(self, 194, '', wx.Point(283,241), wx.Size(80,-1)) #list extents percentages maps
        self.editname = wx.TextCtrl(self, 193, '', wx.Point(250,142), wx.Size(80,-1)) #habitat maps
        self.editname = wx.TextCtrl(self, 195, '', wx.Point(250,295), wx.Size(80,-1)) #raios de influencia para diversidade de shannon
        ...
        #____________________________________________________________________________
        # A button
        self.button =wx.Button(self, 10, "START CALCULATIONS", wx.Point(20, 530))
        wx.EVT_BUTTON(self, 10, self.OnClick)
        self.button =wx.Button(self, 8, "EXIT", wx.Point(270, 530))
        ...
        wx.StaticBitmap(self, -1, jpg1, (20,370), (jpg1.GetWidth(), jpg1.GetHeight()), style=wx.SUNKEN_BORDER)
       ...
       #static text
        ...
        self.SelecMetrcis = wx.StaticText(self,-1,"Codes for habitat:", wx.Point(140,150))

        self.SelecMetrcis = wx.StaticText(self,-1,"Conectivity:", wx.Point(20,180))
        self.SelecMetrcis = wx.StaticText(self,-1,"List Gap crossing (m):", wx.Point(140,180))
        
        self.SelecMetrcis = wx.StaticText(self,-1,"Core/Edge map:", wx.Point(20,208))
        self.SelecMetrcis = wx.StaticText(self,-1,"List Edge deph (m):", wx.Point(140,208))
        
        self.SelecMetrcis = wx.StaticText(self,-1,"Percentage:", wx.Point(20,248))
        ...
        self.SelecMetrcis = wx.StaticText(self,-1,"Extents:", wx.Point(236,248)) # para as pct
        
        self.SelecMetrcis = wx.StaticText(self,-1,"Calculate Statistics:", wx.Point(20,325))
        self.SelecMetrcis = wx.StaticText(self,-1,"Distance from edge :", wx.Point(20,275))
        
        self.SelecMetrcis = wx.StaticText(self,-1,"Create Shannon Diversity:", wx.Point(20,300))
        self.SelecMetrcis = wx.StaticText(self,-1,"Extents (m):", wx.Point(170,300)) # para  diversidade de shannon
        ...
        self.SelecMetrcis = wx.StaticText(self,-1,"Export: Hab/Edge/Matrix", wx.Point(20,348))
        self.SelecMetrcis = wx.StaticText(self,-1,"| Corridor/Branch/SS", wx.Point(170,348))
        ...
        self.insure = wx.CheckBox(self, 97, "", wx.Point(120,180)) # area con connectivity
        wx.EVT_CHECKBOX(self, 97,   self.EvtCheckBox)  
        
        self.insure = wx.CheckBox(self, 150, "", wx.Point(120,208)) #EDGE/Core
        ...
        #essa funcao a baixo eh o botao para saber se vai ou nao calcular o mapa de distancia euclidiana
        #"""
        self.insure = wx.CheckBox(self, 99, "", wx.Point(150,275)) # self.Distedge botaozainho da distancia em relacao a borda
        ...
        """
        self.insure = wx.CheckBox(self, 101, "", wx.Point(150,300)) # Criando mapa de diversidade de shannon
        ...
        """
        self.insure = wx.CheckBox(self, 98, "", wx.Point(150,325)) # self.calcStatistics botaozainho da statisica
        wx.EVT_CHECKBOX(self, 98,   self.EvtCheckBox)      
        
        self.insure = wx.CheckBox(self, 153, "", wx.Point(150,348)) # export hab/edge/matrix
        wx.EVT_CHECKBOX(self, 153,   self.EvtCheckBox)       
        
        self.insure = wx.CheckBox(self, 154, "", wx.Point(275,348)) # export corridor branch ss
