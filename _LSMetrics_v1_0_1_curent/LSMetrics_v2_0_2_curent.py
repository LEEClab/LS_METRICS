  ...
  for i_in in input_maps:
    ...
    for a in list_corridor_width_pixels:
      ...
      if export == True and dirout != '':
        ...
        grass.run_command('r.out.gdal', input = i+'_'+format_escale_name+'m_fragment_AreaHA', output = i+'_'+format_escale_name+'m_fragment_AreaHA.tif', mas)
...
def landscape_diversity(input_maps, scale_list, method = ['simpson'], alpha = [],
  ...
  export: (True/False) logical; if True, the maps are exported from GRASS.
  dirout: string; folder where the output maps will be saved when exported from GRASS. If '', the output maps are generted but are not exported from GRASS.
  ...
  for mm in input_maps:
    ...
    print('....................................................mapval',maps_vals_aux)
    # If the map has less than three values, the diversity values may be meaningless
    if len(map_vals) <= 2:
      print('.....................................................lenmapvals',len(map_vals))
      print('.....................................................lenmapvals',len(mm))
      #format(len(map_vals),mm)
      #warnings.warn('\nYour input map {} has only {} categories.\nLandscape diversity may be meaningless for this map.'.format(len(map_vals),mm)) 
    ...
    for i in scale_list:
      ...
      if export == True and dirout != '':
        ...
        for map_name in map_names_to_export:
          grass.run_command('r.out.gdal', input = map_name, out = map_name+'.tif', overwrite = True) 
...
class LSMetrics(wx.Panel):
    def __init__(self, parent, id):
        ...
        self.editname9 = wx.TextCtrl(self, 198, '', wx.Point(870, 248), wx.Size(60,-1)) 
